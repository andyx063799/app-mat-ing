 ...
 * Aqui hice una simplificacion para solo modificar el elemento HTML.
...
function setVariableMode(vars) {
    ...
    varButtons.forEach((btn) => {
        const isSelected = parseInt(btn.dataset.vars, 10) === vars;
...
varButtons.forEach((btn) => {
    btn.addEventListener('click', () => {
        setVariableMode(parseInt(btn.dataset.vars, 10));
        clearMessage();
    });
});
